        ...
        <div class="content-wrapper">
                        ...
                        <div class="card-body">
                            ...
                            <div
                                ...
                                <svg width="100" height="150" viewBox="0 0 24 32" fill="none"
                                    ...
                                    <!-- Jas dokter -->
                                    <path d="M7 10 Q12 14, 17 10 Q16 22, 12 20 Q8 22, 7 10 Z" fill="#FFFFFF"
                                    ...
                                    <!-- Badan dokter (jubah) -->
                                    <rect x="8" y="15" width="8" height="10" fill="#4A90E2" rx="2"
                                        ry="2" />
                                    ...
                                    <!-- Stetoskop -->
                                    <path d="M12 14 Q10 16, 12 18 Q14 16, 12 14 Z" fill="none" stroke="#000000"
                                        stroke-width="0.5" />
            ...
            <div>
                <div class="btn-wrapper mb-3">
                    <a href="#" class="btn btn-success align-items-center"> <i class="fas fa-paper-plane"></i>
                        Share</a>
                    <a href="#" class="btn btn-primary" onclick="window.print()"><i class="fas fa-print"></i>
                        Print</a>
                </div>
            </div>
            ...
            <div class="home-tab">
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#belumberobat"
                                role="tab" aria-controls="belumberobat" aria-selected="true">Pasien Belum Berobat</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#sudahberobat"
                                role="tab" aria-selected="false">Pasien Sudah Berobat</a>
                        </li>
                    </ul>
                </div>
                <div class="tab-content tab-content-basic">
                    <div class="tab-pane fade show active mb-5" id="belumberobat" role="tabpanel"
                        aria-labelledby="belumberobat">
                        <div class="row">
                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>10/11/2024</td>
                                                                <td class="d-flex">
                                                                    <a href="{{ route('rekam.siswi') }}"
                                                                        class="btn btn-primary mr-4">Pilih</a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
